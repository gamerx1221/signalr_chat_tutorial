...
dotnet user-secrets set "Authentication:Google:ClientId" "" dotnet user-secrets set "Authentication:Google:ClientSecret" ""
...
For Google Authentication, use the following redirect URL: http:///signin-google
...
dotnet user-secrets set "Authentication:Google:ClientId" "" --project "chat_signalr_tutorial" //see credentials.json for actual clientid and secret, hidden here dotnet user-secrets set "Authentication:Google:ClientSecret" "*" --project "chat_signalr_tutorial"
...
dotnet user-secrets set "Authentication:Microsoft:ClientId" "" --project "chat_signalr_tutorial" //see credentials.json for actual clientid and secret, hidden here dotnet user-secrets set "Authentication:Microsoft:ClientSecret" "*" --project "chat_signalr_tutorial"
